...
// <Box style={{color:'white',border:'1px solid white',width:'30%'}}>
//   Side Navbar
// </Box>
// <Box style={{color:'white',border:'1px solid white',width:'70%'}}>
//   Main Content
// </Box>
// </Box>
...
<Box style={{display:'flex',height:'635px'}}>
<Box style={{color:'white',border:'1px solid white',width:'21%',padding:'30px 20px'}}>
  <Box>
...
<Box style={{color:'white',border:'1px solid white',width:'79%'}}>
  {/* Main Content */}
  <LNavbar/>
  <LMain/>
</Box>
