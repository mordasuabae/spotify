...
function Navbar() {
  return (
    <Box style={{border:'1px solid white',padding:'10px 31px',height:'64px',display:'flex',backgroundColor:'transparent'}}>
